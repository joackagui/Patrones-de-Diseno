...
import com.example.scoreit.controller.command.Controller
import com.example.scoreit.controller.command.FinishCommand
import com.example.scoreit.controller.command.FirstTeamAddPointCommand
import com.example.scoreit.controller.command.PointsManager
import com.example.scoreit.controller.command.SecondTeamAddPointCommand
...
class ActivityRefereeButtons : AppCompatActivity() {
    ...
    private fun changeToActivityCupInsight(idCup: String) {
        ...
        activityCupInsight.putExtra(ActivityCupInsight.ID_CUP_CI, idCup)
