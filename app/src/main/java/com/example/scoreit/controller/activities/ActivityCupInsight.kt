...
import com.example.scoreit.view.recyclers.RecyclerMatches
import com.example.scoreit.view.recyclers.RecyclerScoreBoardRows
...
class ActivityCupInsight : AppCompatActivity() {
    ...
    private fun changeToActivityNewCupSettings(idCup: String) {
        ...
        activityNewCupSettings.putExtra(ActivityNewCupSettings.ID_CUP_NC, idCup)
